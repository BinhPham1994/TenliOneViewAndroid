...
public abstract interface EventApi {
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.tenli.oneview.model.network.BaseResponse<java.util.List<com.tenli.oneview.model.network.EventItem>>>> $completion);
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.tenli.oneview.model.network.BaseResponse<com.tenli.oneview.model.network.EventItem>>> $completion);
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.tenli.oneview.model.network.BaseResponse<java.util.List<com.tenli.oneview.model.network.EventTypeDef>>>> $completion);
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.tenli.oneview.model.network.BaseResponse<java.util.List<com.tenli.oneview.model.network.EventGroupDef>>>> $completion);
