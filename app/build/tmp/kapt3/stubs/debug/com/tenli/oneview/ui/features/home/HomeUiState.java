...
public final class HomeUiState {
    ...
    private final java.util.List<com.tenli.oneview.model.network.VmsCountOverviewModel> overviewStats = null;
    @org.jetbrains.annotations.NotNull()
    private final java.util.List<com.tenli.oneview.model.network.VmsEventStatisticalOverTimeModel> eventsOverTime = null;
    @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsCountOverviewModel> component2() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsEventStatisticalOverTimeModel> component3() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsEventCountByTypeModel> component4() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsEventCountByCameraModel> component5() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.tenli.oneview.ui.features.home.HomeUiState copy(boolean isLoading, @org.jetbrains.annotations.NotNull()
    java.util.List<com.tenli.oneview.model.network.VmsCountOverviewModel> overviewStats, @org.jetbrains.annotations.NotNull()
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsCountOverviewModel> getOverviewStats() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsEventStatisticalOverTimeModel> getEventsOverTime() {
        return null;
    }
    
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.VmsEventCountByTypeModel> getEventsByType() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.tenli.oneview.model.network.EventData> getRecentEvents() {
        return null;
    }
