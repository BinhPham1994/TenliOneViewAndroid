...
public final class SettingViewModelAccountExtKt {
    ...
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$prepareEditProfile) {
    }
    
    public static final void onAccountFieldChange(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$onAccountFieldChange, @org.jetbrains.annotations.Nullable()
    ...
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$onGenderSelect, int gender) {
    }
    
    public static final void updateUserProfile(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$updateUserProfile, @org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function0<kotlin.Unit> onSuccess) {
    }
    
    public static final void uploadAvatar(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$uploadAvatar, @org.jetbrains.annotations.NotNull()
    android.net.Uri uri) {
    }
    
    public static final void onPasswordChange(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$onPasswordChange, @org.jetbrains.annotations.Nullable()
    ...
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$changePassword, @org.jetbrains.annotations.NotNull()
    kotlin.jvm.functions.Function0<kotlin.Unit> onSuccess) {
    }
    ...
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$prepareChangePassword) {
    }
    ...
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$clearAccountTempData) {
    }
    
    public static final void fetchClientDevices(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$fetchClientDevices) {
    }
    
    public static final void viewClientDetail(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$viewClientDetail, @org.jetbrains.annotations.NotNull()
    com.tenli.oneview.model.network.ClientDevice device) {
    }
    
    public static final void logoutRemoteClient(@org.jetbrains.annotations.NotNull()
    com.tenli.oneview.ui.features.setting.core.SettingViewModel $this$logoutRemoteClient, int deviceId) {
    }
}